---
title: "Day_6_Biodiversity_Trends"
author: "Cole LaCroix"
date: "2025-02-18"
...
```{r}
plot(antarctic$BP, antarctic$co2ppm, type = 'l', xlab = "Years BP", ylab = "CO2 (ppm)")
...
```
```{r}
xn3 <- predictTrajectory( X.k, ts, afreq, time, periods = milankovitch )
plot( years, cnew,  type = 'l', bty = 'n' )   # compare with original 
lines( ts*afreq*time, xn3, col = 2 )
