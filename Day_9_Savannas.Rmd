...
load( '/Users/GitHub Projects/Ecological_Diversity_and_Climate_Change_wClark/Clark files/annualClimateKruger.rdata', verbose = T )
load( '/Users/GitHub Projects/Ecological_Diversity_and_Climate_Change_wClark/Clark files/monthlyClimateKruger.rdata', verbose = T )
load( '/Users/GitHub Projects/Ecological_Diversity_and_Climate_Change_wClark/Clark files/herbivoreCensus.rdata', verbose = T )
```
```{r}
...
```
```{r}
colBrown2Green <- colorRampPalette(c("saddlebrown", "peru", "tan", "yellowgreen", "forestgreen"))(100)
...
```
```{r}
# do this before climate series in previous plot
